...
Public Class FrmAddCat
    ...
    Private Sub ComStone_DropDown(sender As Object, e As EventArgs) Handles ComStone.DropDown
        ...
        End Try
    End Sub
    Private Sub ComStoneBlock_DropDown(sender As Object, e As EventArgs) Handles ComStoneBlock.DropDown
        Try
            Dim DT As New DataTable
            DT.Clear()
            DT = ClsGoldItem_.Stone()
    ...
    Private Sub Guna2Button4_Click(sender As Object, e As EventArgs) Handles Guna2Button4.Click
        Try
            ...
            ClsGoldItem_.AddItem(TxtCode.Text, 0, 0, TxtBarCode.Text, ComName.Text, ComKart.SelectedValue,
                            ...
                            ComMadIN.SelectedValue, ComSupplier.SelectedValue, TxtPath.Text, TxtNumberPieses.Text,
